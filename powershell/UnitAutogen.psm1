...
.DESCRIPTION
    Exports Cobertura XML (coverage) and JUnit XML (test results) from a
    UnitAutogen run for consumption by Azure DevOps, GitHub Actions, Jenkins,
...
.NOTES
    ...
    credentials from the pipeline secret store:
        ...
        Invoke-UnitAutogen -ServerInstance $srv -Database $db -Credential $cred
    ...
    Exported functions
    ------------------
    Invoke-UnitAutogen          Full pipeline: generate + cover + export both files.
...
function Invoke-UnitAutogen {
    ...
    .SYNOPSIS
        ...
        exports Cobertura XML and JUnit XML.
    ...
    .DESCRIPTION
        ...
        Both XML files are written to OutputPath and are ready to be consumed
        by the pipeline's "Publish Code Coverage Results" and "Publish Test
        Results" tasks.
...
# =============================================================================
Export-ModuleMember -Function Invoke-UnitAutogen,
                               Export-CoverageCoberturaXml,
                               Export-TestResultsJunitXml,
                               Export-CoverageHtmlReport
